...
class AIVoiceAssistant:
    def __init__(self):
        ...
        self._service_context = ServiceContext.from_defaults(llm=self._llm, embed_model=HuggingFaceEmbedding(model_name="sentence-transformers/all-MiniLM-L6-v2"))
        self._index = None
        self._create_kb()
    ...
    def _prompt(self):
        return """
            You are a professional AI Assistant pdf reader. You can answer questions related to the the provided pdf.
